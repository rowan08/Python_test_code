...
class Tall_button(Button):
    ...
    def __init__(self, master=None, cnf={}, **kw):
        ...
        self.config(height=11, width=10)
...
class App():
    ...
    def __init__(self, master):
        ...
        self.display = Message(master, padx=10, pady=20, width=320, textvariable=self.display_variable)
        self.display.config(font=('times', 30), borderwidth=1, relief=RAISED)
        ...
        equals_button.grid(row=4, column=3, rowspan=2)
    ...
    def set_display_text(self, display_value):
        ...
        self.display_variable.set(return_value)
